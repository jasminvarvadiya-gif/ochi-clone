...
function Footer() {
  return (
    <div>
      <div className=" w-full h-screen py-10 px-15 flex gap-5 font-['font-2'] ">
        <div className="w-1/2 h-full flex flex-col justify-between ">
          <div className="heading ">
            <h1 className=" text-[10vw] uppercase leading-none -mb-10">EYE-</h1>
            <h1 className=" text-[10vw] uppercase leading-none -mb-10">
              Opening
            </h1>
          </div>
        </div>
        <div className="w-1/2 h-screen">
          ...
          <div className="s">
            <h1 className=" text-2xl pt-3 pb-5 font-['font-1']">S:</h1>
            <div className="link">
              <a href="#" className=" text-xd font-['font-1'] underline">
                Instagram
              </a>
              <br />
              <a href="# " className=" text-xd font-['font-1'] underline">
          ...
          <div className="L-m flex justify-between items-center">
            <div className="l">
              <h1 className=" text-2xl pt-3 pb-3 font-['font-1']">L:</h1>
              <div className="link">
                <a href="#" className=" text-xd font-['font-1'] underline">
                  202-1965 W 4th Ave
                </a>
            ...
            <div className="M">
              <h1 className=" text-2xl pt-3 pb-3 font-['font-1']">M:</h1>
              <div className="link">
                <a href="#" className=" text-xl font-['font-1'] underline">
                  Home
                </a>
                <br />
                <a href="# " className=" text-xl font-['font-1'] underline">
          ...
          <div className="E">
            <h1 className=" text-2xl py-2 font-['font-1']">E:</h1>
            <div className="link">
              <a href="#" className=" text-xd font-['font-1'] underline">
                hello@ochi.design
              </a>
      ...
      <div className="txt flex items-center justify-between pt-15 px-15">
            <div className="svg">
              <svg
                width="72"
                height="30"
            ...
            <div className="frist">
              <a href="#" className="text-zinc-500 text-xl py-10 ps-85">
                &copy;ochi design 2026. Legal Terms
              </a>
            </div>
            <div className="second">
              <a href="#" className=" text-zinc-400 text-xl py-10">
                Website by Obys
              </a>
            </div>
          </div>
