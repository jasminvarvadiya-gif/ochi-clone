  ...
  return (
    <>
      <div className="container w-full">
        <div className="content mx-w-[1170px]">
          <div className="w-full fixed z-[999] sm:justify-between bg-transparent py-8 flex px-15 items-center font-['font-1'] justify-between">
            ...
            <div className="btn">
              <button
                className="lg:hidden text-2xl w-full"
